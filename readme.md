...
# Blog+Cms in laravel
> **Note:** This repository contains the core code of a blog+cms project in laravel.
...
## About The Project
A content management system (CMS) is a web-based software that allows to build content-oriented websites, like blogs, eCommerce websites, or portfolios. In this project i have developed a cms along with blog, inspired by "WordPress".
...
* Post tags feature 
* Post archives
* Handle comments to particular post
...
1. Clone the repo
```sh
https://github.com/Masud99Rana/Blog-Cms-in-laravel.git
```
